...
const Home = () => {
    return (
      <>
                              {/* Home */}
        {/* <home className = "flex items-center m-auto">
          <div className = "lg:ml-10 sm:mt-4 text-gray-600 body-font">
          <div className="container flex md:flex-row flex-col items-center" >
          <div className="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
          <h1 className="title-font sm:text-4xl text-3x1 font-medium text-gray-900">Welcome to Uber store
          Get your necessary rides now.
            </h1>
            <p className="mb-8 leading-relaxed">Copper mug try-hard pitchfork pour-over freegan heirloom neutra air plant cold-pressed tacos poke beard tote bag. Heirloom echo park mlkshk tote bag selvage hot chicken authentic tumeric truffaut hexagon try-hard chambray.</p>
            <div className="flex justify-center">
            <button className="inline-flex text-white bg-red-800 border-0 py-2 px-6 focus:outline-none hover:bg-red-900 rounded text-lg">Get started</button>
            <button className="ml-4 inline-flex text-gray-700 bg-gray-100 border-0 py-2 px-6 focus:outline-none hover:bg-gray-200 rounded text-lg">Read documentation</button>
            </div>
          </div>
          <div className="lg:max-w-lg lg:w-full md:w-1/2 w-5/6">
            <img className="object-cover object-center rounded W-contain" alt="hero" src={taxi}></img>
            </div>
              </div>
              </div>
        </home> */}
        ...
        <div class="w-full h-96 mx-auto">
            <div class="items-center lg:flex">
                <div class="w-full h-6/12 lg:w-1/2">
                    <div class="lg:max-w-lg">
                    <h1 className="title-font sm:text-4xl text-3x1 font-medium text-gray-900">Welcome to Uber store
                      Get your necessary rides now.
                        </h1>
                        <p className="ml-4 mb-8 leading-relaxed">Copper mug try-hard pitchfork pour-over freegan heirloom neutra air plant cold-pressed tacos poke beard tote bag. Heirloom echo park mlkshk tote bag selvage hot chicken authentic tumeric truffaut hexagon try-hard chambray.</p>
                        <button className="inline-flex text-white bg-red-800 border-0 py-2 px-6 focus:outline-none hover:bg-red-900 rounded text-lg">Get started</button>
                        <button className="ml-4 inline-flex text-gray-700 bg-gray-100 border-0 py-2 px-6 focus:outline-none hover:bg-gray-200 rounded text-lg">Read documentation</button>
                    </div>
                </div>
                ...
                <div class="flex items-center justify-center w-full mt-6 lg:mt-0 lg:w-1/2">
                    <img class="w-8/12 h-10/12 lg:max-w-2xl" src={taxi} alt="Catalogue-pana.svg"/>
                </div>
            </div>
        </div>
    </header>
                              ...
                              {/* Team Info */}
        <section class="ontainer p-4 mx-auto bg-gray-50 dark:bg-gray-800">
          ...
          <div class="flex items-center justify-center">
            ...
            <a href="#" class="text-xl font-bold text-gray-800 dark:text-white hover:text-gray-700 dark:hover:text-gray-300">Uber</a>
